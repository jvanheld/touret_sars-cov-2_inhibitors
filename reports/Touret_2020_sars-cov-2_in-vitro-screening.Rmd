...
inhibTable$chemicalName[supTable$ID, "chemicalName"] <- supTable$Chemical.name
...
```{r raw_viab_distrib, fig.width=7, fig.height=5, out.width="60%"}
...
hist(inhibTable$viability, 
     ...
     las = 1,
     breaks = 100, col = "grey", border = "grey")
