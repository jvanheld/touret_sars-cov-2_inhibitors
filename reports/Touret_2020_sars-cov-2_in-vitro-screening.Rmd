...
```{r boxplots_per_plate, fig.width=7, fig.height=12, out.width="80%", fig.cap="Distribution of raw viability valyes per plate"}
#### Boxplots per plate  ####

# par(mfrow = c(1,2))
# # names(inhibTable)
# boxplot(viability ~ Plate, 
...
```{r boxplots_per_plate_log2, fig.width=7, fig.height=12, out.width="80%", fig.cap="Distribution of raw viability valyes per plate"}


#### Boxplots per plate of log2_transformed viability####
...
**I (JvH) think this should be reported to the company that produces these plates**
