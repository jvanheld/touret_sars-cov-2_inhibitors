...
inhibTable$selected.arbidolMean <- as.numeric(inhibTable$viability > statPerPlate[inhibTable$Plate, "arbidolMean"])
...
criteria <- c("FDR", "ii", "both", "either", "onlyFDR", "onlyii", "arbidolMean")
